...
export default function FileUploadModal(props) {
    ...
    const fileTypes = ["png", "jpg", "jpeg", "tif"];
  ...
  return (
      ...
      >
        ...
        <Grid item xs={9}>
            <h2 style={styles.header}>Upload Image File</h2>
        </Grid>
        <Grid item xs={3}>
        ...
        <Grid item xs={12}>
            <Button id="upload-button" style={styles.button} onClick={() => props.handleUpload(file)}>Upload File</Button>
        </Grid>
        </Grid>
    </Modal>
  );
