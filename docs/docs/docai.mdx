...
This page describes the worklfow used to process well records through DocAI.
...
flowchart TD
    ...
    subgraph Extract
        ...
        buck_b --> og_script --> mod_ex_ab-- data --> og_db
    end
...
Google DocAI needs at least 10 training documents and 2 testing documents to automatically
...
they need to be grouped into categories.
...
10 training and 2 testing documents.
...
To do this, one must first train the processor, adding schema (field) labels for every field of all documents.

#### Training

As for the Split and Classify steps, Google DocAI needs at least 10 training and 2 testing documents to create a model.
